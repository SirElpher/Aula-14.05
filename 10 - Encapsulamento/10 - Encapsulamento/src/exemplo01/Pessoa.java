...
public class Pessoa {
	 ...
	 * 
	 * DEFAULT -> Atributos e métodos visíveis no mesmo pacote. PUBLIC ->
	 * Atributos e métodos visíveis para qualquer classe. PRIVATE -> Atributos e
	 * métodos visíveis apenas na classe que foram criados. PROTECTED ->
	 * Atributos e métodos visíveis nas classes criadas ou herdadas.
	 */

	// Atributos da classe Pessa
	String nome;
	double peso, altura;

	// metodo para retornar o calculo de IMC
	...
	public void obterDados(){
		nome = JOptionPane.showInputDialog("Informe seu mome");
